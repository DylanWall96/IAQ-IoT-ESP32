...
//Watchdog Timer
  ...
  File file = SD.open("/WKitchenData.txt");
  if(!file) {
    Serial.println("File doens't exist");
    Serial.println("Creating file...");
    writeFile(SD, "/WKitchenData.txt", "Day, Timestamp, Temperature, Pressure, Humidity, Gas, Score, Location \r\n");
  }
  else {
...
void loop() {
  ...
  //const char* serverName = "http://dylaniot.ddns.net/IAQIOT/BME680KitchenData.php";
  const char* serverName = "http://192.168.1.64/AirQualityProject/BME680KitchenData.php";
...
void logSDCard() {
  ...
  appendFile(SD, "/WKitchenData.txt", dataMessage.c_str());
}
